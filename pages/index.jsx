        ...
        {answer ?
          <>
            ...
            <div className='relative flex justify-center'>
              <Image className='w-full max-w-[40em]' src='/magic_ball.png' width={550} height={434} />
          ...
          <>
            ...
            <div className='flex justify-center w-1/2 flex-wrap flex-row space-y-6'>
              ...
              <button type="button" className="text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-lg px-5 py-2.5 text-center mr-2 mb-2" onClick={handleClick}>Top'a Sor!</button>
            </div>
          </>
        }
      </div>
